...
public:
  ...
  Histogram1DDataBlock(LargeRAWFile_ptr pStreamFile, uint64_t iOffset, bool bIsBigEndian);
...
protected:
  ...
  template < class T > void ComputeTemplate(const TOCBlock* source, uint64_t iLevel) {
